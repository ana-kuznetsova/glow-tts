...
class Mel2MelLoader(torch.utils.data.Dataset):
    """
        1) loads source <-> target audio paird
        3) computes mel-spectrograms from audio files.
    """
    def __init__(self, audiopaths_and_text, hparams):
        self.audiopaths_and_text = load_filepaths_and_text(audiopaths_and_text)
        #List of format [[source_path, target_path]]
    ...
    def get_mel_mel_pair(self, audiopath_and_text):
        ...
        source_audiopath, target_audiopath = audiopath_and_text[0], audiopath_and_text[1]
